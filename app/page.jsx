    ...
    <>
      ...
      <section className="block hero">
        <div className="grid grid--1x2">
          ...
          <picture>
            ...
            />
            <img className="hero__image" src="/images/mounttamalpais-23.jpg" alt="" />
          </picture>
        </div>
      </section>
      ...
      <article className="grid grid--1x2-1 feature">
        <div data-aos="fade-left">
          ...
          <p className="aboutMe__description">
            My name is Viraaj Rane. I&apos;m currently a first year student at UC San Diego
            pursuing a Bachelor&apos;s degree in Computer Science. Photography has been a passion
            of mine for several years, and I specialize in wildlife photography as well as portrait
            photography. I love capturing the beauty of nature and the essence of people through my
            lens. However, I love to explore different genres such as sports and automotive
            photography.
          </p>

          <Link style={{ paddingLeft: "2rem" }} href="/about" className="link-arrow">
            Learn More
          </Link>
        </div>
          ...
          <div className="plan" data-aos="fade-right" data-aos-delay="100">
            <div className="card card--secondary">
              ...
              <div className="card__body">
                ...
                <Link href="/bookings" className="btn btn--outline btn--block btn--primary">
      ...
      <header>
        ...
        <section className="home__gallery">
          <Link data-aos="fade-right" className="home__gallery_option" href="/events">
            <img src="/images/events/anjali_grad-1.jpg" alt="" />
          </Link>

          <Link data-aos="fade-left" className="home__gallery_option" href="/cars">
